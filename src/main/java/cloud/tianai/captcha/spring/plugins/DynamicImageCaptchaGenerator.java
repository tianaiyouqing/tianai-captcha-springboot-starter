...
import cloud.tianai.captcha.spring.autoconfiguration.SliderCaptchaCacheProperties;
...
@Getter
@Setter
public class DynamicImageCaptchaGenerator implements ImageCaptchaGenerator, ApplicationListener<ApplicationReadyEvent> {

    protected ImageCaptchaProperties prop;
    ...
    public DynamicImageCaptchaGenerator(ImageCaptchaProperties prop,
